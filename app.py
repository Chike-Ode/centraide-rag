        ...
        prompt_templates = {
            "Français": PromptTemplate(
                ...
                template=(  
                    ...
                    "1. \"Bonjour Eko\"\n"
                    "   Bonjour je suis Eko expert en itinérance à Montréal. Comment je peux vous aider aujourd'hui...\n\n"
                    ...
                    "{chat_history}\n\n"
                    "En fonction du contexte fourni et de l'historique de la conversation, veuillez répondre à la question brièvement:\n\n"
                    "Contexte : {context}\n\n"
                    "Question : {question}\n\n"
            ...
            "English": PromptTemplate(
                ...
                template=(  
                    ...
                    "1. \"Hi Eko\"\n"
                    "   Hello, I am Éko, expert in homelessness in Montreal. How can I assist you today...\n\n"
